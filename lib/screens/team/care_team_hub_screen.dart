...
/// and re-tapping it pops the branch back here). The body is a [HubGrid]
/// of six [HubTile]s in the documented order; each tile pushes its
/// feature page (the routes that don't exist yet land in Phases 14.27+).
class CareTeamHubScreen extends StatelessWidget {
