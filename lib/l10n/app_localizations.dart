...
abstract class AppLocalizations {
  ...
  /// Field label for the optional 'what calms them' input.
  ///
  /// In en, this message translates to:
  /// **'What calms them (optional)'**
  String get lovedOneSetupCalmsLabel;

  /// Hint describing the 'what calms them' multiline field.
  ///
  /// In en, this message translates to:
  /// **'One per line — phrases, people, or things that help.'**
  String get lovedOneSetupCalmsHintList;

  /// Placeholder hint for the 'what calms them' field.
  ///
  /// In en, this message translates to:
  /// **'e.g. A photo of their late husband'**
  String get lovedOneSetupCalmsHint;

  /// Field label for the optional 'what escalates them' input.
  ///
  /// In en, this message translates to:
  /// **'What escalates them (optional)'**
  String get lovedOneSetupEscalatesLabel;

  /// Hint describing the 'what escalates them' multiline field.
  ///
  /// In en, this message translates to:
  /// **'One per line — triggers to avoid.'**
  String get lovedOneSetupEscalatesHintList;

  /// Placeholder hint for the 'what escalates them' field.
  ///
  /// In en, this message translates to:
  /// **'e.g. Loud beeping, being rushed'**
  String get lovedOneSetupEscalatesHint;

  /// Section heading for the primary-caregiver contact fields.
  ///
  /// In en, this message translates to:
  /// **'Primary caregiver'**
  String get lovedOneSetupCaregiverHeading;

  /// Hint explaining where the primary-caregiver contact appears.
  ///
  /// In en, this message translates to:
  /// **'Shown on the Emergency Card for first responders.'**
  String get lovedOneSetupCaregiverHint;

  /// Field label for the primary-caregiver name input.
  ///
  /// In en, this message translates to:
  /// **'Name (optional)'**
  String get lovedOneSetupCaregiverNameLabel;

  /// Placeholder hint for the primary-caregiver name field.
  ///
  /// In en, this message translates to:
  /// **'Your name'**
  String get lovedOneSetupCaregiverNameHint;

  /// Field label for the primary-caregiver phone input.
  ///
  /// In en, this message translates to:
  /// **'Phone (optional)'**
  String get lovedOneSetupCaregiverPhoneLabel;

  /// Placeholder hint for the primary-caregiver phone field.
  ///
  /// In en, this message translates to:
  /// **'(555) 123-4567'**
  String get lovedOneSetupCaregiverPhoneHint;
